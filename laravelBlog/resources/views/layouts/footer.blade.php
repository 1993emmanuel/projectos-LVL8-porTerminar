<footer class="bg-gray-800 py-20 mt-20">
	...
	<div class="sm:grid grid-cols-3 w-4/5 pb-10 m-auto border-b-2 border-gray-700">
		...
		<div>
			<h3 class="text-l sm:font-bold text-gray-100">Lates Posts</h3>
			<ul class="py-4 sm:text-s pt-4 text-gray-400">
				<li class="pb-1"><a href="/">Why we love tech</a></li>
				<li class="pb-1"><a href="/blog">why we love design</a></li>
				<li class="pb-1"><a href="/login">why to use laravel</a></li>
		...
		<p class="w-25 w-4/5 pb-3 m-auto text-sm text-gray-100 pt-6">
			CopyRight 2017-2021 code with emmanuel All right resource
		</p>
